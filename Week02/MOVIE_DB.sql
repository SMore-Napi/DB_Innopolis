...
INSERT INTO DIRECTING(person_id, movie_id)
VALUES (5, 1),
       (3, 2);
...
INSERT INTO ACTING(person_id, movie_id, role)
VALUES (1, 2, 'Vito Carleone'),
       (2, 2, 'Michael Carleone'),
       (4, 1, 'Rocky Balboa');

INSERT INTO QUOTES(acting_id, quote)
VALUES (1, 'Revenge is a dish best served cold'),
       (2, 'There are negotiations being made that are going to answer all of your questions and solve all of your problems. That’s all I can tell you right now. Carlo, you grew up in Nevada. When we make our move there you’re going to be my right hand man. Tom Hagen is no longer Consigliari. He’s going to be our lawyer in Vegas. That’s no reflection on Tom it’s just the way I want it. Besides, if I ever help who’s a better Consigliari than my father. That’s it.'),
       (2, 'I’ll make him an offer he can’t refuse. You see, Johnny, we feel that entertainment is going to be a big factor in drawing gamblers into the casinos. We’re hoping that you’ll sign a contract agreeing to appear 5 times a year. Perhaps convince some of your friends in the movies to do the same. We’re counting on you, Johnny.'),
       ...
       (3, 'Life’s not about how hard of a hit you can give… it’s about how many you can take, and still keep moving forward.');
